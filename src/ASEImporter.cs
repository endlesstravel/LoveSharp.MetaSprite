...
namespace MetaSprite {
    ...
    public class ImportContext {
        ...
        public string atlasPath; // need to report
    ...
    public static class ASEImporter {
        ...
        static void ImportStage(ImportContext ctx, Stage stage) {
            Console.WriteLine("Importing " + ctx.fileName, stage.GetDisplayString(), stage.GetProgress());
        }
        ...
        static void GenerateAnimClips(ImportContext ctx) {
            ...
            foreach (var tag in ctx.file.frameTags) {
                ...
                if (loop) {
                    clip.wrapMode = AsepriteWrapMode.Loop;
                    settings.loopBlend = true;
                    settings.loopTime = true;
                } else {
                    clip.wrapMode = AsepriteWrapMode.Clamp;
